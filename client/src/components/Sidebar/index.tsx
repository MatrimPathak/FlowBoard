  ...
  return (
    <div className={sidebarClassNames}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        {/* TOP LOGO */}
        <div className="z-50 flex min-h-[56px] w-64 items-center justify-between border-x-pink-600 bg-white px-6 pt-3 dark:bg-black">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image src="https://flowboard-s3-images.s3.ap-south-1.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
          <div className="">
